...
namespace LMirman.VespaIO
{
	...
	public static class VespaInstanceFinder
	{
		...
		private static readonly Dictionary<Type, SearchResults> SearchResultsMap = new(CacheCount + 1);
		...
		private class SearchResults
		{
			...
			public void PerformSearch()
			{
				...
				objects = Object.FindObjectsByType(declaringType, FindObjectsInactive.Include);
            }
		}
	}
}