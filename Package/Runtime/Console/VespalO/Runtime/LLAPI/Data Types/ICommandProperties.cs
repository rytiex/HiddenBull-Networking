namespace LMirman.VespaIO
{
	public interface ICommandProperties
	{
        ...
        /// <summary>
        /// If true, this command is server-authoritative: when invoked on a pure client it is
        /// not executed locally but routed to the server (see <see cref="Console.ServerCommandRouter"/>).
        /// </summary>
